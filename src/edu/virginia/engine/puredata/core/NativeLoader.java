...
public class NativeLoader {
  ...
  private static void loadLibraryFromJar(String library) {
    ...
    InputStream in =
        org.puredata.core.PdBase.class.getResourceAsStream("natives/" + osName + "/" + osArch + "/" + library);
    if (in == null) {
      in = org.puredata.core.PdBase.class.getResourceAsStream("natives/" + osName + "/" + library);
    }
    if (in == null) {
