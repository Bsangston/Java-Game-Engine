...
public class GamePad {
	...
	public static final String BUTTON_CROSS = "14"; //X on ps3
	public static final String BUTTON_CIRCLE = "13"; //Cross on ps3
	public static final String BUTTON_SQUARE = "15"; //Square on ps3
	public static final String BUTTON_TRIANGLE = "12"; //Triangle on ps3
	
	public static final String BUTTON_L1 = "10"; //L1 hammer on ps3
	public static final String BUTTON_R1 = "11"; //R1 hammer on ps3

	public static final String BUTTON_L2 = "8";
	public static final String BUTTON_R2 = "9";

	public static final String BUTTON_L3 = "1";
	public static final String BUTTON_R3 = "2";

	public static final String BUTTON_SELECT = "0"; //previously 6 (cross)
	public static final String BUTTON_START = "0";
	
	public static final String DPAD_UP = "4";   //4 on ps3
	public static final String DPAD_RIGHT = "5"; //5 on ps3
	public static final String DPAD_LEFT = "7"; //6 on ps3
	public static final String DPAD_DOWN = "6"; //7 on ps3
